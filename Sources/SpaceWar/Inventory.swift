...
// Stub for Inventory.cpp

import Steamworks

/// These are hardcoded in the game and match the item definition IDs which were uploaded to Steam.
enum SpaceWarItemDefID: Int {
    case timedDropList = 10
    case shipDecoration1 = 100
    case shipDecoration2 = 101
    case shipDecoration3 = 102
    case shipDecoration4 = 103
    case shipWeapon1 = 110
    case shipWeapon2 = 111
    case shipSpecial1 = 120
    case shipSpecial2 = 121
}

struct SpaceWarItem {
    let details: SteamItemDetails

    fileprivate init(details: SteamItemDetails) {
        self.details = details
    }

    var itemID: SteamItemInstanceID { details.id }
    var definition: SteamItemDef { details.definitionIndex }
    var quantity: UInt16 { details.quantity }
...
final class SpaceWarLocalInventory {
    let steam: SteamAPI
    ...
    func checkForItemDrops() {}
    //  void DoExchange();
    func doExchange() {}
    //  void ModifyItemProperties();
    func modifyItemProperties() {}
    //
    ...
    func hasInstanceOf(_ def: SpaceWarItemDefID) -> Bool { true }
    ...
    var lastDroppedItem: SpaceWarItem? { nil }
